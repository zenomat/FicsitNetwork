...
function LoadFiles(debug)
    ...
    ReadFileFromGithub("http://192.168.10.106/LuaCode/AlumFactory3/InitComponents.lua", debug)
    ReadFileFromGithub("http://192.168.10.106/LuaCode/AlumFactory3/MainLoop.lua", debug)
end
