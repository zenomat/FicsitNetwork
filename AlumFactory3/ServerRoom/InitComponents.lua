...
function Initialization(debug)
    ...
    panel = LoadComponent("Panel_ServerRoom", debug) -- panel at server room
...
function LoadFiles(debug)
    ...
    ReadFileFromGithub("http://192.168.10.106/LuaCode/AlumFactory3/ServerRoom/InitComponents.lua", debug)
    ReadFileFromGithub("http://192.168.10.106/LuaCode/AlumFactory3/ServerRoom/MainLoop.lua", debug)
end
